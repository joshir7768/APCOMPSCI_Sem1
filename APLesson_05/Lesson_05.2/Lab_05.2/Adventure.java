...
public class Adventure
{
	public static void main(String[]args)
	{
		...
		else
		{
			...
			if(choice ==2)
			{
				System.out.println("You find the room with the information but you notice someone behind.There is a gaurd that looks ready to call someone on his walkie-talkie and charge at you. He is much bigger than you and looks very intimidating. What do you do?  ");
				System.out.println("Would you" +  
